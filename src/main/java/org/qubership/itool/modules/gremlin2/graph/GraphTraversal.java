...
public interface GraphTraversal<S, E> extends Traversal<S, E> {
    ...
    default <E2> GraphTraversal<S, E2> union(Traversal<?, E2> ... unionTraversals) {
        return (GraphTraversal)this.asAdmin().addStep(
            new UnionStep<E, E2>(this.asAdmin(), Arrays.copyOf(unionTraversals, unionTraversals.length, Traversal.Admin[].class))
        );
    }
    ...
    default <E2> GraphTraversal<S, E2> or(final Traversal<?, E2> ... orTraversals) {
        return (GraphTraversal)this.asAdmin().addStep(
            new OrStep<E>(this.asAdmin(), Arrays.copyOf(orTraversals, orTraversals.length, Traversal.Admin[].class))
        );
    }
